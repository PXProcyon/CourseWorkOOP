...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        item.setText(_translate("Dialog", "Название тарифа"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("Dialog", "Кол-во минут на номера других операторов"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("Dialog", "Введите кол-во минут на номера домащнего оператора"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("Dialog", "Кол-во смс"))
        item = self.tableWidget.horizontalHeaderItem(5)
        item.setText(_translate("Dialog", "Интернет-соединение"))
        item = self.tableWidget.horizontalHeaderItem(6)
        item.setText(_translate("Dialog", "Скорость интернет-соединения"))
        item = self.tableWidget.horizontalHeaderItem(7)
        item.setText(_translate("Dialog", "Стоимость тарифа"))
        item = self.tableWidget.horizontalHeaderItem(8)
        item.setText(_translate("Dialog", "Номер перехода на тариф"))
